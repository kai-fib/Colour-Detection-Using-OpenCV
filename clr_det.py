# -*- coding: utf-8 -*-
"""
Created on Thu Dec 31 12:18:33 2020
...
while True:
    ...
    cnts1= cv2.findContours(mask1,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE)
    cnts1 = imutils.grab_contours(cnts1)
    
    cnts2 = cv2.findContours(mask2,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE)
    cnts2 = imutils.grab_contours(cnts2)
    
    cnts3 = cv2.findContours(mask3,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE)
    cnts3 = imutils.grab_contours(cnts3)
    
    cnts4 = cv2.findContours(mask4,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE)
